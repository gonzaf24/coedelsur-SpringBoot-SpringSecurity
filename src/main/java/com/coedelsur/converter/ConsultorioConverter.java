...
@FacesConverter("consultoriosConverter")
public class ConsultorioConverter implements Converter<Object> {
	 ...
	 public Object getAsObject(FacesContext ctx, UIComponent uic, String value) {
	    	...
	    	if (crearTurnosMB !=null && crearTurnosMB.getListConsultorios() != null ) {
	            boolean encontre = false;
	            for (int i = 0; i < crearTurnosMB.getListConsultorios().size() && !encontre; i++) {
	                doc = crearTurnosMB.getListConsultorios().get(i);
