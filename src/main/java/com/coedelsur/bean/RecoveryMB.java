...
public class RecoveryMB implements Serializable {
	...
	public String resetPassword() {
		...
		try {
			...
			Mail mail = new Mail(email, user.getUsername(), "Resetear Password COEdelSUR", " Clica en el siguiente enlace para restaurar su constraseña \r\n" + url);
        ...
        email = new String();
        return "Consulte su casilla de correo con el email y el link";
	}
	
    public void savePassword() throws Exception {
    	try {
	    	Usuario user = LoginPersistence.obtenerUsuarioById(idPers);
