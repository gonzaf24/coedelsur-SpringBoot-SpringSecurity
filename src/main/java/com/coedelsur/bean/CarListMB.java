...
import com.coedelsur.infra.model.Filter;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
            	...
            	com.coedelsur.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.coedelsur.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.coedelsur.infra.model.SortOrder.DESCENDING
                            : com.coedelsur.infra.model.SortOrder.UNSORTED;
                }
